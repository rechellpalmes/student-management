...
body {
  background: url(img/CPC2.jpg) repeat center center fixed ;
    ...
    <div class="col-md-4">
      ...
      <section class="login-form"> <?php echo check_message(); ?>
        <form  method="post" action="" role="login">
           <img src="img/CPC.jpg" class="img-responsive" alt="" /> 
...
if(isset($_POST['btnLogin'])){
  ...
  //it creates a new objects of member
    ...
    if ($res==true) { 
       message("You Successfully login as ".$_SESSION['ACCOUNT_TYPE'].".","success");
